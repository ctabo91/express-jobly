...
describe("findAll", function () {
  ...
  test("works: with filters 'name & maxEmployees'", async function() {
    let companies = await Company.findAll({name: 'c2', maxEmployees: 2});
    expect(companies).toEqual([
      {
        handle: "c2",
        name: "C2",
  ...
  test("bad request: min > max", async function() {
    try {
...
describe("get", function () {
  test("works", async function () {
    ...
    expect(company).toEqual({
      ...
      logoUrl: "http://c1.img",
      jobs: [
        { id: testJobIds[0], title: "J1", salary: 1000, equity: "0.010" }
      ]
    });
  });

...
describe("GET /companies", function () {
  ...
  test("works: with correct query string passed", async function() {
  ...
  test("fails: invalid query string passed", async function() {
    const resp = await request(app).get("/companies?description=Desc2");
    expect(resp.statusCode).toEqual(400);
  });
});
